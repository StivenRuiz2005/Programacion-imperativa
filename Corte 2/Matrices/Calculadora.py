...
def agregar():
    ...
    num1array=np.array([0])
    num2array=np.array([0])
    num1array = np.insert(num1array,num1array.size,float(num1))
    num2array = np.insert(num2array,num2array.size,float(num2))
    print(num1array)
